...
@Component({
  selector: 'app-infra-compu-dep',
  templateUrl: './infra-compu-dep.component.html',
  styleUrls: ['./infra-compu-dep.component.css'],
  providers: [RegistroartService]
})
export class InfraCompuDepComponent implements OnInit {
