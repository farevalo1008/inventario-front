...
@Component({
  selector: 'app-mobi-asig',
  templateUrl: './mobi-asig.component.html',
  styleUrls: ['./mobi-asig.component.css'],
  providers: [RegistroartService]
})
export class MobiAsigComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      this._asignacionService.buscarPersonal().subscribe(
        ...
        console.log("LINEA 89",this.grupo);
          }
        );
    ...
    this._asignacionService.asig_personal().subscribe(
      response => {
        ...
        console.log("LINEA 97",this.todos);
      },
      error =>{
        console.log(error);
      }
...
BorrarAsignacion(){
  ...
  // console.log("LINEA 365",this.verEquipo[this.conta]);
