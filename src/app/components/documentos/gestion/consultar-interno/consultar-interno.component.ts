...
declare var $: any;
@Component({
  selector: 'app-consultar-interno',
  templateUrl: './consultar-interno.component.html',
  styleUrls: ['./consultar-interno.component.css']
})
export class ConsultarInternoComponent implements OnInit {
  public buscarmodel = new Buscarmodel('', '', null, null, null, null, '', '', '', null, null, null, null, null);
  public myFile: string;
  public bandera: boolean = false;
  public message: String;
  public status: string;
  public datanombres: Array<any>;
  public dataEditar: Array<any>;
  ...
  ngOnInit() {
    ...
    this._documentoService.getdocumentointerno().subscribe(
      response => {
  ...
  onSubmit() {
    this._documentoService.buscarDocumentointerno(this.buscarmodel).subscribe(
      response => {
  ...
  Editar(form) {
    ...
    console.log(this.nombreDocumentoPrueba, 'HOLII');
